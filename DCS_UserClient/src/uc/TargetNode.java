...
public class TargetNode {
	...
	public static String ucGetLocalIP() {
		...
		System.out.println("客户端IP地址为：" + ind.getHostAddress().toString());
	...
	public static String ucTargetNode(String MasterIP) {
		...
		try {
			...
			System.out.println("连接请求来自Master：" + connectToMaster.getInetAddress().getHostAddress());
			String targetIP = null;
			targetIP = fromMaster.readUTF();
			System.out.println("本机客户端的目标存储节点地址为：" + targetIP);
			fromMaster.close();
			outToMaster.close();
